...
public class Animate_Welcome : MonoBehaviour
{
    
    RectTransform MovingText;  //Declare RectTransform in script
    Vector3 startingPos = new Vector3(-1355, -211, 0);
    Vector3 endPos = new Vector3(1396, -211, 0); //La nueva posición del texto.
    ...
    void Update()
    {
        if(Estado == Parado)
        {
            ...
            MovingText.localPosition =  Vector3.MoveTowards(MovingText.localPosition, endPos, 2.00f);
        }
